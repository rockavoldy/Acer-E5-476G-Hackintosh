 ...
 *
 * Disassembly of SSDT-6-ACRPRDCT.aml, Sat May 11 00:40:10 2019
 *
...
DefinitionBlock ("", "SSDT", 1, "ACRSYS", "ACRPRDCT", 0x00001000)
{
    ...
    External (_SB_.PCI0.IGPU.CADL, UnknownObj)    // (from opcode)
    External (_SB_.PCI0.IGPU.CAL2, UnknownObj)    // (from opcode)
    External (_SB_.PCI0.IGPU.CAL3, UnknownObj)    // (from opcode)
    External (_SB_.PCI0.IGPU.CAL4, UnknownObj)    // (from opcode)
    External (_SB_.PCI0.IGPU.CAL5, UnknownObj)    // (from opcode)
    External (_SB_.PCI0.IGPU.CAL6, UnknownObj)    // (from opcode)
    External (_SB_.PCI0.IGPU.CAL7, UnknownObj)    // (from opcode)
    External (_SB_.PCI0.IGPU.CAL8, UnknownObj)    // (from opcode)
    External (_SB_.PCI0.IGPU.CDCK, UnknownObj)    // (from opcode)
    External (_SB_.PCI0.IGPU.CPDL, UnknownObj)    // (from opcode)
    ...
    External (_SB_.PCI0.IGPU.CPL5, UnknownObj)    // (from opcode)
    External (_SB_.PCI0.IGPU.CPL6, UnknownObj)    // (from opcode)
    External (_SB_.PCI0.IGPU.CPL7, UnknownObj)    // (from opcode)
    External (_SB_.PCI0.IGPU.CPL8, UnknownObj)    // (from opcode)
    External (_SB_.PCI0.LPCB.EC_.CTMP, IntObj)    // (from opcode)
    External (_SB_.PCI0.LPCB.EC_.EC6I, UnknownObj)    // (from opcode)
    External (_SB_.PCI0.LPCB.EC_.EC6O, UnknownObj)    // (from opcode)
    External (_SB_.PCI0.LPCB.EC_.FBST, UnknownObj)    // (from opcode)
    External (_SB_.PCI0.LPCB.EC_.GPSW, IntObj)    // (from opcode)
    External (_SB_.PCI0.LPCB.EC_.SCTB, MethodObj)    // 0 Arguments (from opcode)
    External (_SB_.PCI0.LPCB.EC_.VGAF, UnknownObj)    // (from opcode)
    External (_SB_.PCI0.RP01, DeviceObj)    // (from opcode)
    External (_SB_.PCI0.RP01.PXSX, DeviceObj)    // (from opcode)
    External (_SB_.PCI0.RP01.PXSX._ADR, UnknownObj)    // (from opcode)
    External (_SB_.VSSD, UnknownObj)    // (from opcode)
    ...
    Scope (\_SB.PCI0.RP01.PXSX)
    {
        ...
        Method (HGON, 0, Serialized)
        {
            ...
            Store (One, \_SB.PCI0.LPCB.EC.VGAF)
        ...
        Method (HGOF, 0, Serialized)
        {
            ...
            SGPO (HLRS, One)
            SGPO (PWEN, Zero)
            Store (Zero, \_SB.PCI0.LPCB.EC.VGAF)
            \_SB.PCI0.LPCB.EC.SCTB ()
            Return (Zero)
        }
        ...
        Method (GPS, 4, Serialized)
        {
            ...
            Switch (ToInteger (Arg2))
            {
                ...
                Case (0x13)
                {
                    ...
                    Store (One, PSTE)
                    Store (Zero, \_SB.PCI0.LPCB.EC.GPSW)
                    Return (Local1)
                }
                Case (0x20)
                {
                    ...
                    Switch (ToInteger (QUTP))
                    {
                        Case (Zero)
                        {
                            If (CPUT)
                            {
                                Store (0x0200, STSV)
                                Or (STSV, QUTP, STSV)
                                Store (\_SB.PCI0.LPCB.EC.CTMP, PDTS)
                            }
