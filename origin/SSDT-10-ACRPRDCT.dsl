 ...
 *
 * Disassembly of SSDT-10-ACRPRDCT.aml, Fri Jun 21 00:37:33 2019
 *
...
DefinitionBlock ("", "SSDT", 1, "ACRSYS", "ACRPRDCT", 0x00001000)
{
    ...
    External (_SB_.PCI0.LPCB.EC0_.GPSW, IntObj)    // (from opcode)
    External (_SB_.PCI0.LPCB.EC0_.SCTB, MethodObj)    // 0 Arguments (from opcode)
    External (_SB_.PCI0.LPCB.EC0_.VGAF, UnknownObj)    // (from opcode)
