 ...
 *
 * Disassembly of SSDT-5-ACRPRDCT.aml, Fri Jun 21 00:37:33 2019
 *
        ...
        Device (TPM)
        {
            ...
            Method (_CRS, 0, Serialized)  // _CRS: Current Resource Settings
            {
                If (LNotEqual (PTTB, 0xFED40040))
                {
                    ...
                    CreateDWordField (CRS0, \_SB.TPM._CRS._Y26._BAS, CBAS)  // _BAS: Base Address
                    Store (PTTB, CBAS)
                    Return (CRS0)
                }
                Else
            ...
            OperationRegion (TNVS, SystemMemory, 0x8AF6F000, 0x26)
